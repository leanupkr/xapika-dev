...
export default async function SupplyChainPage({
  ...
  const tRelated = await getTranslations(
    "solutionsDetail.supplyChain.relatedProjects"
  );
  const tCta = await getTranslations("solutionsDetail.supplyChain.cta");
  const tSol = await getTranslations("solutions.items.supply");
