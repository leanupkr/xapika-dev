...
const SLIDES = [
  { src: "/portfolios/warsaw-tram/hero-tram-4263.jpg", alt: "Warsaw tram 4263 — Tramwaje Warszawskie maintenance program" },
  ...
  { src: "/portfolios/warsaw-tram/hero-maint-crew.jpg", alt: "Technician servicing tram roof equipment in progress — Warsaw depot" },
] as const;
